...
#define STKDIR				0x3D
#define SC7A20_ACC_IOCTL_SET_ENABLE			_IOW(STKDIR, 0x03, char)
#define SC7A20_ACC_IOCTL_GET_ENABLE			_IOR(STKDIR, 0x04, char)
#define SC7A20_ACC_IOCTL_SET_DELAY			_IOW(STKDIR, 0x05, char)
#define SC7A20_ACC_IOCTL_GET_DELAY			_IOR(STKDIR, 0x06, char)
...
#define SC7A20_ACC_IOCTL_GET_COOR_XYZ           _IOW(SC7A20_ACC_IOCTL_BASE, 22, int)
...
#define SC7A20_WHO_AM_I_WIA_ID (0x11 << 0)
