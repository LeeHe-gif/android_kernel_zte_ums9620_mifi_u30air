...
#ifndef _GCORE_DRV_CONFIG_H_
#define _GCORE_DRV_CONFIG_H_

#define TOUCH_DRIVER_RELEASE_VERISON   ("3.6.1.3_240301")
...
#define CONFIG_TOUCH_DRIVER_INTERFACE_SPI_MODE
 ...
 */
#define CONFIG_GCORE_RESUME_EVENT_NOTIFY (0)
